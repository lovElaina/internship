...
const PostTableList = () => {
  ...
  return (
    <WrapContent>
      {
        currentUserInfo? <div style={{ width: '100%', float: 'right' }}>
          ...
          <ProTable
            ...
            request={(params) =>
              getPostList({...params,companyId:(currentUserInfo.data)?currentUserInfo.data.companyId : ''}).then((res) => {
                console.log(currentUserInfo)

                // let tmp;
                // if(currentUserInfo?.data !== null){
                //   tmp = res.rows.filter((e) => {
                //     console.log(currentUserInfo)
                //     return e.companyId === currentUserInfo?.data.companyId
                //   })
                // }else tmp = res;
                // console.log(tmp)
                return {
      ...
      <UpdateForm
        onSubmit={async (values) => {
          ...
          if(isQueryMode){
            ...
            if(currentUserInfo.data !== null){
              values.companyId = currentUserInfo.data.companyId;
              if (values.postId) {
